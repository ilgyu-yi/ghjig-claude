...
- **activation-/completion-/changelog-evidence** — fail-closed gates: Proposed→Active flip (trusted pass comment), Directive completed-close (§5.13 comment), `gh pr ready` (fragment or skip label) (SPEC §6.1).
