...
## MISSION fit
<Which `MISSION.md` section or success criterion does this Directive serve? One sentence naming the section. e.g., "Serves MISSION's 'Success looks like > The directing layer works' criterion — completes the §2.1 state diagram so the Directive lifecycle is fully executable end-to-end." (If the repo has no `MISSION.md` yet, say so honestly — the Directive may motivate a MISSION amendment.)>
